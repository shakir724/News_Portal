            ...
            <div>
                ...
                <div class="nav__list">
                    ...
                    <ul class="dropdown-menu nav-drop" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item active" href="state.php">State</a></li>
...
<section id="tab1">
    <div class="navbar">
        ...
        <div class="navbar-right">
            <p>Dashboard / Edit/add/delete <span class="p-span">/ State</span></p>
        </div>
    </div>

    <button class="btn res-btn" onclick="togglePopup1()"><i class='bx bx-plus'></i>Add State</button>
    ...
    <div class="popup" id="popup-a">
        ...
        <div class="content">
            ...
            <form action="add_state.php" method="post" class="res-pop-form">
    ...
    include 'db.php';
        //session_start();
    $state = mysqli_query($con, "SELECT * FROM states ORDER BY state");
    while ($row = mysqli_fetch_array($state)) {
        ...
        <div class="row">
            <div class="col-12 table1">
                <div class="row row1">
                    <div class="col">
                        <h6 class="h6-1"><?php echo $row['state']; ?></h6>
                    </div>
                    <div class="col-4">
                        <button class="action-btn1" id="edit-state" onclick="togglePopup(<?php echo $row['state_id']; ?>)" ><i class="fas fa-edit fas-lg">Edit</i></button>

                        <div class="popup" id="popup-<?php echo $row['state_id']; ?>">
                            <div class="overlay"></div>
                            <div class="content">
                                <div class="close-btn" onclick="togglePopup(<?php echo $row['state_id']; ?>)">&times;</div>

                                <form action="edit_state.php" method="POST" class="res-pop-form">
                                    <label for="state">Edit State:</label>
                                    <input type="text" value="<?php echo $row['state']; ?>" name="state" class="form-control" id="" placeholder="State">
                        ...
                        <button class="action-btn2" onclick="return confirm('Are you sure to Delete?')" ><a href="delete_state.php?msg=<?php echo $row['state_id']; ?>" class="title-a">
                            <i class="far fa-newspaper"><i class="far fa-trash-alt fas-lg"></i>Delete</i></a></button>
                        </div>
           ...
           <!-- <div class="col-12 table1">
                <div class="row row1">
                    <div class="col">
                        <h6 class="h6-1">Bihar</h6>
                    </div>
                    <div class="col-4">
                        <button class="action-btn1"><i class="fas fa-edit fas-lg"></i>Edit</button>
                        <button class="action-btn2"><i class="far fa-trash-alt fas-lg"></i>Delete</button>
                    </div>
