            ...
            <div>
                ...
                <div class="nav__list">
                    ...
                    <ul class="dropdown-menu nav-drop" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item active" href="city.php">City</a></li>
...
<section id="tab1">
    <div class="navbar">
        ...
        <div class="navbar-right">
            <p>Dashboard / Edit/add/delete <span class="p-span">/ City</span></p>
        </div>
    </div>

    <button class="btn res-btn" onclick="togglePopup1()"><i class='bx bx-plus'></i>Add City</button>
    ...
    <div class="popup" id="popup-a">
        ...
        <div class="content-city">
            ...
            <form action="add_city.php" method="post" class="city-pop-form">
                ...
                <select id="district" name="district" class="select-city">
    ...
    <?php
    $result1 = mysqli_query($con, "SELECT * FROM cities ORDER BY city");
    while ($row = mysqli_fetch_array($result1)) {
        ...
        <div class="row">
            <div class="col-12 table1">
                <div class="row row1">
                    <div class="col">
                        <h6 class="h6-1"><?php echo $row['city']; ?></h6>
                    </div>
                    <div class="col-4">
                        <button class="action-btn1" onclick="togglePopup(<?php echo $row['city_id']; ?>)" ><i class="fas fa-edit fas-lg">Edit</i></button>

                        <div class="popup" id="popup-<?php echo $row['city_id']; ?>">
                            <div class="overlay"></div>
                            <div class="content">
                                <div class="close-btn" onclick="togglePopup(<?php echo $row['city_id']; ?>)">&times;</div>

                                <form action="edit_city.php" method="post" class="res-pop-form">
                                    <label for="state">Edit City:</label>
                                    <input type="text" name="city" class="form-control" id="state" value="<?php echo $row['city'] ?>" placeholder="State">
                        ...
                        <button class="action-btn2" onclick="return confirm('Are you sure to Delete?')" ><a href="delete_city.php?msg=<?php echo $row['city_id']; ?>"><i class="far fa-trash-alt fas-lg">Delete</i></a></button>
                    </div>
