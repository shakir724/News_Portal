        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a href="restricted.php" class="nav__link active">
...
<section id="tab1">
    <div class="navbar">
        <div class="navbar-left">
            <h5>Restricted Words</h5>
        </div>
        <div class="navbar-right">
            <p>Dashboard <span class="p-span">/ Restricted Words</span></p>
        </div>
    </div>

    <button class="btn res-btn " onclick="togglePopup1()"><i class='bx bx-plus'></i>Add Word</button>
    ...
    <div class="popup" id="popup-a">
        ...
        <div class="content">
            ...
            <form action="add_restrict.php" method="post" class="res-pop-form">
                
                    <p>Add Restricted Word</p>
                    <input type="text" name="res" class="form-control" placeholder="Add Word">
    ...
    <?php
    include 'db.php';
    $comment = mysqli_query($con, "SELECT * FROM restricted_words ORDER BY word");
    while ($row = mysqli_fetch_array($comment)) {
        ...
        <div class="row">
            <div class="col-12 table1">
                <div class="row row1">
                    <div class="col">
                        <h6 class="h6-1"><?php echo $row['word']; ?></h6>
                    </div>
                    <div class="col-4">
                        <button class="action-btn1" onclick="togglePopup(<?php echo $row['word_id']; ?>)" ><i class="fas fa-edit fas-lg">Edit</i></button>

                        <div class="popup" id="popup-<?php echo $row['word_id']; ?>">
                            <div class="overlay"></div>
                            <div class="content">
                                <div class="close-btn" onclick="togglePopup(<?php echo $row['word_id']; ?>)">&times;</div>

                                <form action="edit_restrict.php" method="POST" class="res-pop-form">
                                    <label for="state">Edit Word:</label>
                                    <input type="text" value="<?php echo $row['word']; ?>" name="word" class="form-control" id="" placeholder="Category">
                                    <input type="hidden" name="word_id" value="<?php echo $row['word_id']; ?>">
                        ...
                        <button class="action-btn2"><a href="delete_restrict.php?msg=<?php echo $row['word_id']; ?>"><i class="far fa-trash-alt fas-lg">Delete</i></a></button>
                    </div>
                </div>
            </div>
