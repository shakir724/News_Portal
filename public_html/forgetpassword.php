...
<body>
    <section id="register-pg">
        ...
        <form action="forget_process.php" method="post">
            <div class="form1">
                <input type="text" name="email" placeholder="Enter your E-mail" class="form1-mob">
            </div>
            ...
            <div class="box">
                ...
                <button class="butto"><i class="fa fa-google far"></i></button>
                <button class="butto"><i class="fa fa-facebook-square fas" ></i></button>
                <button class="butto"><i class="fa fa-twitter fas1"></i></button>
            ...
            <p class="text-center text1">Copyright @ 2020. All rights reserved.</p>

            <div class="text-center">
                <button type="submit" class="btn balance-btn1 text-center">Next</button>
            </div>  
        </form>
    </section>
    ...
    <?php
    if (isset($_GET["msg"]) && $_GET["msg"] == 'invalido')
    {
        ?> <script> alert("Your OTP is Wrong"); </script>
        <?php
    }
    ?>
</body>
