...
<body>
    <section id="register-pg">
        ...
        <form action="forget_process2.php" method="post">
            <div class="form1">
                <input type="text" name="otp" placeholder="Enter your OTP" class="form1-mob">
            </div>
                    <div class="form1">
    ...
    <button type="submit" class="btn balance-btn1 text-center">Submit</button>
    </div>  
        </form>
     </section>
    </body>
